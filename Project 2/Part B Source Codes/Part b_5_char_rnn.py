...
def genAccLossFig3(epoch, train_loss, train_acc, test_acc, name=''):
  ...
  plt.savefig('/content/gdrive/My Drive/CZ4042 Dataset/images/Q3/Q3_Figure1_'+str(epoch)+name+'.png')
  plt.close()

HIDDEN_SIZE = 20

def rnn_char_model(x, dropout = 0.0):
...
def main():
  ...
  for prob in probability:
    ...
    inputs, logits = rnn_char_model(x, prob)
    ...
    with tf.Session() as sess:
      ...
      for epoch in range(NUM_EPOCHS):
        ...
        if epoch%100 == 0:
          genAccLossFig3(epoch, train_loss, train_acc, test_acc, '_'+str(prob))
          pd.DataFrame(train_loss).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q3/Q3train_loss_'+str(epoch)+'_'+str(prob)+'.csv')
          pd.DataFrame(train_acc).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q3/Q3train_acc_'+str(epoch)+'_'+str(prob)+'.csv')
          pd.DataFrame(test_acc).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q3/Q3test_acc_'+str(epoch)+'_'+str(prob)+'.csv')
