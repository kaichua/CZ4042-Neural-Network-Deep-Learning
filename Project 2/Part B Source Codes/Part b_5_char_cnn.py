...
def main():
  ...
  for prob in probability:
    ...
    inputs, logits = char_cnn_model(x, prob)
    ...
    with tf.Session() as sess:
      ...
      for epoch in range(NUM_EPOCHS):
        ...
        if epoch%100 == 0:
          genAccLossFig1(epoch, train_loss, train_acc, test_acc, '_'+str(prob))
          pd.DataFrame(train_loss).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q1/Q1train_loss_'+str(epoch)+'_'+str(prob)+'.csv')
          pd.DataFrame(train_acc).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q1/Q1train_acc_'+str(epoch)+'_'+str(prob)+'.csv')
          pd.DataFrame(test_acc).to_csv('/content/gdrive/My Drive/CZ4042 Dataset/csv/Q5/Q1/Q1test_acc_'+str(epoch)+'_'+str(prob)+'.csv')
